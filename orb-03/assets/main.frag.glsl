...
uniform float uColor2Offset;
uniform float uColor3Offset;
...
vec3 calculateSurfaceColor() {
  ...
  baseSurfaceColor = mix(baseSurfaceColor, uColor2, smoothstep(1.0 - uColorNoiseGamma, uColorNoiseGamma, colorNoiseValRaw_A + uColor2Offset));
  baseSurfaceColor = mix(baseSurfaceColor, uColor3, smoothstep(1.0 - uColorNoiseGamma, uColorNoiseGamma, colorNoiseValRaw_B + uColor3Offset));
...
void main() {
  ...
  color = saturation(color, uColorSaturation);
